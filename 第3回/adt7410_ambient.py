...
import ambient #ambientを使うためのライブラリ

#チャネルID、ライトキー、リードキーを設定
CHANNEL_ID = '67811'
WRITE_KEY  = '3b9c7399f9a500f8'
READ_KEY   = '8217b04bbd03b233'
...
amb = ambient.Ambient(CHANNEL_ID,WRITE_KEY,READ_KEY) #ambientの設定

try:
    while True:
        inputValue = read_adt7410() #read_adt7410()を呼び出して温度値を取得
        response = amb.send({'d1': inputValue})
        print(inputValue)
        sleep(60)
